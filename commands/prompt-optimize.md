...
Analyze and optimize the following prompt for maximum LSZ leverage.
...
3. **LSZ Component Matching** — Map to specific skills, commands, agents, and model tier
...
- Present diagnosis, recommended LSZ components, and an optimized prompt using the Output Format from the prompt-optimizer skill
