...
2. Review the newly injected Domain Rules. If they instruct you to load an Expert Skill (e.g., `programming-expert` (`rust-expert`)), use the `Skill` tool to retrieve it BEFORE making any code changes.
