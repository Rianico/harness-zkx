...
| Skill | Relationship |
|-------|-------------|
| Eval Gate (quick mode) | Use `eval-gate quick` for deterministic checks (build, lint, test). Santa for semantic checks (accuracy, hallucinations). Run eval-gate quick first, Santa second. |
