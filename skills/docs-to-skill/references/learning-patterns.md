...
Reference quality is governed by extraction rules, not line counts. Key signals:

| Signal | Check |
|--------|-------|
| Metadata header | Version, date, source, author, generated by, brief present |
| Schema compliance | File follows a template schema from extraction-rules.md |
