---
name: exa-search
description: "Web, code, and research search via the Exa MCP server. Use when the user wants to search the web, find code examples, research companies, look up people, discover recent articles, or run AI-powered deep research. Triggers on: search for, find, look up, research, who is, what is, latest on. Integrates with the Exa MCP server for neural search."
