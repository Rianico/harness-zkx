# Packaging — Deep Reference

> Source: Wshobson python-packaging (`python-packaging/SKILL.md` + references/details.md). Curated for python-expert progressive disclosure.
...
- `python-packaging` from `wshobson/agents` (`plugins/python-development/skills/python-packaging/`) — https://github.com/wshobson/agents
