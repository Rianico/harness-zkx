# Project Structure — Deep Reference

> Source: Wshobson python-project-structure (`python-project-structure/SKILL.md`). Curated for python-expert progressive disclosure.
...
- `python-project-structure` from `wshobson/agents` (`plugins/python-development/skills/python-project-structure/`) — https://github.com/wshobson/agents
