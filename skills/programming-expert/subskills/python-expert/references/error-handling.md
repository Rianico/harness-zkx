...
> Source: Wshobson python-error-handling (`python-error-handling/SKILL.md` + references/details.md). Curated for python-expert progressive disclosure.
...
- `python-error-handling` from `wshobson/agents` (`plugins/python-development/skills/python-error-handling/`) — https://github.com/wshobson/agents
