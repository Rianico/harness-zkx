...
> Source: Wshobson async-python-patterns (`async-python-patterns/SKILL.md` + references/details.md). Curated for python-expert progressive disclosure.
...
- `async-python-patterns` from `wshobson/agents` (`plugins/python-development/skills/async-python-patterns/`) — https://github.com/wshobson/agents
