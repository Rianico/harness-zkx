# Code Style — Deep Reference

> Source: Wshobson python-code-style (`python-code-style/SKILL.md`). Curated for python-expert progressive disclosure.
...
- `python-code-style` from `wshobson/agents` (`plugins/python-development/skills/python-code-style/`) — https://github.com/wshobson/agents
