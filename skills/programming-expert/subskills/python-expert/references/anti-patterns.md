# Anti-Patterns — Full Checklist

> Source: Wshobson python-anti-patterns (`python-anti-patterns/SKILL.md`). Curated for python-expert progressive disclosure.
...
- `python-anti-patterns` from `wshobson/agents` (`plugins/python-development/skills/python-anti-patterns/`) — https://github.com/wshobson/agents
