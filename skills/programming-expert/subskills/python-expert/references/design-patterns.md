# Design Patterns — Deep Reference

> Source: Wshobson python-design-patterns (`python-design-patterns/SKILL.md` + references/details.md). Curated for python-expert progressive disclosure.
...
- `python-design-patterns` from `wshobson/agents` (`plugins/python-development/skills/python-design-patterns/`) — https://github.com/wshobson/agents
