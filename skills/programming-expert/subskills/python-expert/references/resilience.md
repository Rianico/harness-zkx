...
> Source: Wshobson python-resilience (`python-resilience/SKILL.md` + references/details.md). Curated for python-expert progressive disclosure.
...
- `python-resilience` from `wshobson/agents` (`plugins/python-development/skills/python-resilience/`) — https://github.com/wshobson/agents
