# Resource Management — Deep Reference

> Source: Wshobson python-resource-management (`python-resource-management/SKILL.md` + references/details.md). Curated for python-expert progressive disclosure.
...
- `python-resource-management` from `wshobson/agents` (`plugins/python-development/skills/python-resource-management/`) — https://github.com/wshobson/agents
