...
> Source: Wshobson python-testing-patterns (`python-testing-patterns/SKILL.md` + references/details.md). Curated for python-expert progressive disclosure.
...
- `python-testing-patterns` from `wshobson/agents` (`plugins/python-development/skills/python-testing-patterns/`) — https://github.com/wshobson/agents
