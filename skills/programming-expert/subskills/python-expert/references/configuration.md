...
> Source: Wshobson python-configuration (`python-configuration/SKILL.md` + references/details.md). Curated for python-expert progressive disclosure.
...
- `python-configuration` from `wshobson/agents` (`plugins/python-development/skills/python-configuration/`) — https://github.com/wshobson/agents
