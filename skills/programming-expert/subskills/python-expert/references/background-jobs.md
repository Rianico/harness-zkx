# Background Jobs — Deep Reference

> Source: Wshobson python-background-jobs (`python-background-jobs/SKILL.md` + references/details.md). Curated for python-expert progressive disclosure.
...
- `python-background-jobs` from `wshobson/agents` (`plugins/python-development/skills/python-background-jobs/`) — https://github.com/wshobson/agents
