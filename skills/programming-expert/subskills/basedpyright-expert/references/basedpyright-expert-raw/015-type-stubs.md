...
![Pyright](https://docs.basedpyright.com/latest/usage/CreateTypeStub1.png)
...
![Pyright](https://docs.basedpyright.com/latest/usage/CreateTypeStub2.png)

Note

these instructions are specific to VScode, but this functionality is also available in [other supported editors](https://docs.basedpyright.com/latest/installation/ides/) as well, since this functionality is built into [the language server](https://microsoft.github.io/language-server-protocol/specifications/lsp/3.17/specification/#textDocument_codeAction).
...
For example: `pyright --createstub django`
