...
description: >-
  Create stunning, animation-rich HTML presentations from scratch or by converting PowerPoint files. Use to build presentations, convert PPT/PPTX to web, or create slides for a talk/pitch. Helps non-designers discover their aesthetic through visual exploration rather than abstract choices.
---
...
2. Generate **3 single-slide preview files** in `.lsz-design/slide-previews/`.
