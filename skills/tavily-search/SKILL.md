---
name: tavily-search
description: "Web search with LLM-optimized results via the Tavily CLI. Use when the user wants to search the web, find articles, look up information, get recent news, or discover sources. Triggers on: search for, find me, look up, what's the latest on, find articles about. Returns content snippets, relevance scores, and metadata. Supports domain filtering, time ranges, and search depth control."
