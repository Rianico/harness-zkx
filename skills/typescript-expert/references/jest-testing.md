...
> Source: `github/awesome-copilot/javascript-typescript-jest`. Use when writing or fixing Jest tests. No duplication with advanced types.
...
> [!note] React guidance
> Prefer React Testing Library + `userEvent` over `fireEvent`; query by role/label/text.

> [!warning] Keep snapshots small and review changes before commit.
