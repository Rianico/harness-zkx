...
description: >
  Transportation carrier management expertise for freight operations. Covers
  carrier portfolio strategy, freight rate negotiation (linehaul, FSC, accessorials),
  RFP processes, carrier scorecarding (OTD, tender acceptance, claims ratio),
  routing guide management, FMCSA compliance vetting, and market intelligence
  (DAT, Greenscreens). Use when managing carrier relationships, negotiating
  freight rates, running carrier RFPs, evaluating carrier performance, building
  routing guides, onboarding new carriers, or making spot vs. contract decisions.
license: Apache-2.0
version: 1.0.0
