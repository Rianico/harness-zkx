...
description: >-
  Expert methodology for React, Next.js, Vue, and Nuxt. Use when building components, managing state, optimizing performance, or diagnosing SSR/hydration issues.
argument-hint: |-
