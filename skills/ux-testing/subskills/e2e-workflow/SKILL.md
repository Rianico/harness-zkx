---
name: e2e-workflow
description: Build maintainable E2E test infrastructure with Page Object Model, locator strategies, and flakiness quarantine. TRIGGER on E2E testing, Playwright setup, test infrastructure, POM, locator strategy, flaky tests.
arguments: feature
argument-hint: |
