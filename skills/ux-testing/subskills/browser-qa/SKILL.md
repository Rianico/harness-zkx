---
name: browser-qa
description: Ad-hoc QA and post-deploy monitoring for UI verification. Supports single-pass checks, sustained monitoring, and environment comparison. TRIGGER on browser testing, UI verification, post-deploy check, staging vs prod, ad-hoc QA.
