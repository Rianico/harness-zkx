...
**Source:** https://microsoft.github.io/language-server-protocol/specifications/lsp/3.17/specification/#code-action-request-leftwards_arrow_with_hook
...
_Since version 3.16.0:_ a client can offer a server to delay the computation of code action properties during a ‘textDocument/codeAction’ request:
...
> _Since version 3.8.0:_ support for CodeAction literals to enable the following scenarios:
