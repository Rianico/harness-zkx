...
`classjinja2.ChainableUndefined`
...
`classjinja2.FileSystemLoader(searchpath,encoding='utf-8',followlinks=False)`
...
`classjinja2.PackageLoader(package_name,package_path='templates',encoding='utf-8')`
...
`classjinja2.DictLoader(mapping)`
...
`classjinja2.FunctionLoader(load_func)`
...
`classjinja2.PrefixLoader(mapping,delimiter='/')`
...
`classjinja2.ChoiceLoader(loaders)`
...
`classjinja2.bccache.Bucket(environment,key,checksum)`
...
`classjinja2.FileSystemBytecodeCache(directory=None,pattern='__jinja2_%s.cache')`
...
`classjinja2.MemcachedBytecodeCache(client,prefix='jinja2/bytecode/',timeout=None,ignore_memcache_errors=True)`
...
`exceptionjinja2.TemplateError(message=None)`
...
`exceptionjinja2.TemplateNotFound(name,message=None)`
...
`exceptionjinja2.TemplateSyntaxError(message,lineno,name=None,filename=None)`
...
`exceptionjinja2.TemplateRuntimeError(message=None)`
...
`exceptionjinja2.TemplateAssertionError(message,lineno,name=None,filename=None)`
...
`classjinja2.nodes.EvalContext(environment,template_name=None)`
