...
name: firecrawl
description: >-
  Firecrawl CLI for web search, scraping, crawling, site mapping, and document parsing. Use when finding pages, extracting markdown from URLs, mapping site structure, or converting local documents to markdown.
argument-hint: |-
