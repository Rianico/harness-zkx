*[ratatui_core](../index.md) / [symbols](index.md)*
...
- [`braille`](braille/index.md) — Braille symbols.
- [`half_block`](half_block/index.md)
- [`line`](line/index.md)
- [`marker`](marker/index.md)
- [`merge`](merge/index.md) — This module provides strategies for merging symbols in a layout.
- [`pixel`](pixel/index.md) — Pseudo-pixel symbols: quadrant, sextant and octant characters.
- [`scrollbar`](scrollbar/index.md)
- [`shade`](shade/index.md)
...
- `fn clone(&self) -> Marker` — [`Marker`](marker/index.md#marker)
...
- `fn default() -> Marker` — [`Marker`](marker/index.md#marker)
...
- `fn from_str(s: &str) -> ::core::result::Result<Marker, <Self as ::core::str::FromStr>::Err>` — [`Marker`](marker/index.md#marker)
...
- `fn eq(&self, other: &Marker) -> bool` — [`Marker`](marker/index.md#marker)
