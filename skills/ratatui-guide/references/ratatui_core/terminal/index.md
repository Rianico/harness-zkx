*[ratatui_core](../index.md) / [terminal](index.md)*
...
by implementing [`Backend`](../backend/index.md).

# How it works

`Terminal` ties together a [`Backend`](../backend/index.md), a [`Viewport`](../index.md), and a double-buffered diffing renderer.
...
`Terminal` is generic over a [`Backend`](../backend/index.md) implementation and does not depend on a particular
...
- `fn size(&self) -> Result<Size, <B as >::Error>` — [`Size`](../index.md#size), [`Backend`](../backend/index.md#backend)
