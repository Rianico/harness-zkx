*[ratatui_core](../index.md) / [buffer](index.md)*
...
- `fn merge_symbol(&mut self, symbol: &str, strategy: MergeStrategy) -> &mut Self` — [`MergeStrategy`](../symbols/merge/index.md#mergestrategy)

  Merges the symbol of the cell with the one already on the cell, using the provided

  [`MergeStrategy`](../symbols/merge/index.md).
  ...
  produce a valid character. [`MergeStrategy`](../symbols/merge/index.md) defines how to handle such cases, e.g.,
...
- `const fn style(&self) -> Style` — [`Style`](../style/index.md#style)
