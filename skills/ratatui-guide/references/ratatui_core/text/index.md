*[ratatui_core](../index.md) / [text](index.md)*
...
- `fn new<S: Into<Style>>(symbol: &'a str, style: S) -> Self`
  ...
  `style` accepts any type that is convertible to [`Style`](../style/index.md) (e.g. [`Style`](../style/index.md), [`Color`](../index.md), or
...
- `fn style(&self) -> Style` — [`Style`](../style/index.md#style)
...
- `fn add_modifier(self, modifier: Modifier) -> T` — [`Modifier`](../style/index.md#modifier)

- `fn remove_modifier(self, modifier: Modifier) -> T` — [`Modifier`](../style/index.md#modifier)
...
The line's [`Style`](../style/index.md) is used by the rendering widget to determine how to style the line. Each
[`Span`](../index.md) in the line will be styled with the [`Style`](../style/index.md) of the line, and then with its own
[`Style`](../style/index.md). If the line is longer than the available space, the style is applied to the entire
...
- `fn raw<T>(content: T) -> Self`
  ...
  A [`Line`](../index.md) can specify a [`Style`](../style/index.md), which will be applied before the style of each [`Span`](../index.md)
...
- `fn styled_graphemes<S: Into<Style>>(self: &'a Self, base_style: S) -> impl Iterator<Item = StyledGrapheme<'a>>` — [`StyledGrapheme`](../index.md#styledgrapheme)
  ...
  `base_style` is the [`Style`](../style/index.md) that will be patched with each grapheme [`Style`](../style/index.md) to get

  the resulting [`Style`](../style/index.md).

  

  `base_style` accepts any type that is convertible to [`Style`](../style/index.md) (e.g. [`Style`](../style/index.md), [`Color`](../index.md),
...
- `fn styled_graphemes<S: Into<Style>>(self: &'a Self, base_style: S) -> impl Iterator<Item = StyledGrapheme<'a>>` — [`StyledGrapheme`](../index.md#styledgrapheme)
  ...
  `base_style` is the [`Style`](../style/index.md) that will be patched with the `Span`'s `style` to get the

  resulting [`Style`](../style/index.md).
...
The text's [`Style`](../style/index.md) is used by the rendering widget to determine how to style the text. Each
[`Line`](../index.md) in the text will be styled with the [`Style`](../style/index.md) of the text, and then with its own
[`Style`](../style/index.md). `Text` also implements [`Styled`](../index.md) which means you can use the methods of the
