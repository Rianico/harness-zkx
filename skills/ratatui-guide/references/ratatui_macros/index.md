...
* Use `span!` macro inside [`line!`](../ratatui_core/symbols/line/index.md) macro for formatting.
...
* Use [`line!`](../ratatui_core/symbols/line/index.md) or `span!` macro inside `text!` macro.
