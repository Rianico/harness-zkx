*[ratatui](../index.md) / [init](index.md)*
...
All functions in this module use the [`CrosstermBackend`](../backend/index.md) by default, which provides excellent
...
5. Construct [`Terminal`](../prelude/index.md) manually only when these helpers do not match the backend or terminal
   lifecycle you need.
...
These higher-level helpers are the normal application path. Manual [`Terminal`](../prelude/index.md) construction is
...
- Backend: [`CrosstermBackend`](../backend/index.md) writing to `Stdout`
- Raw mode is enabled
...
- A [`Terminal`](../prelude/index.md) is created using [`CrosstermBackend`](../backend/index.md) writing to `Stdout`
...
This is a [`Terminal`](../prelude/index.md) using the [`CrosstermBackend`](../backend/index.md) which writes to `Stdout`. This is a
reasonable default for most applications. To use a different backend or output stream, instead
use [`Terminal`](../prelude/index.md) and a [backend][`crate::backend`](../backend/index.md) of your choice directly.
