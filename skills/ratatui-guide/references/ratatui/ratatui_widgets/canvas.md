*[ratatui_widgets](./index.md) / [canvas](#)*
...
- `fn block(self, block: Block<'a>) -> Self` — [`Block`](./block.md#block)
  ...
  Wraps the canvas with a custom [`Block`](./block.md) widget.
...
- `const fn marker(self, marker: Marker) -> Self`
  ...
  but you might want to use the simple `Dot` or [`Block`](./block.md) instead if the targeted terminal
  ...
  than with a grid of characters (e.g. with [`Block`](./block.md) or `Dot`) but lower than with
