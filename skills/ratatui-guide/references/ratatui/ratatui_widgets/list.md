...
This [`Style`](../ratatui_core/style.md) will be combined with the [`Style`](../ratatui_core/style.md) of the inner [`Text`](../ratatui_core/index.md). The [`Style`](../ratatui_core/style.md)
of the [`Text`](../ratatui_core/index.md) will be added to the [`Style`](../ratatui_core/style.md) of the [`ListItem`](./index.md).
...
- `fn style<S: Into<Style>>(self, style: S) -> Self`
  ...
  This [`Style`](../ratatui_core/style.md) can be overridden by the [`Style`](../ratatui_core/style.md) of the [`Text`](../ratatui_core/index.md) content.
...
This is different from a [`Table`](./table.md) because it does not handle columns, headers or footers and
the item's height is automatically determined. A `List` can also be put in reverse order (i.e.
*bottom to top*) whereas a [`Table`](./table.md) cannot.
...
- `fn block(self, block: Block<'a>) -> Self` — [`Block`](./block.md#block)
  ...
  Wraps the list with a custom [`Block`](./block.md) widget.

  

  The `block` parameter holds the specified [`Block`](./block.md) to be created around the [`List`](#list)
