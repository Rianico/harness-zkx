...
| [`block`](#block) | mod |  |
| [`border`](#border) | mod |  |
| [`braille`](#braille) | mod | Braille symbols. |
| [`half_block`](#half-block) | mod |  |
| [`line`](#line) | mod |  |
| [`marker`](#marker) | mod |  |
| [`merge`](#merge) | mod | This module provides strategies for merging symbols in a layout. |
| [`pixel`](#pixel) | mod | Pseudo-pixel symbols: quadrant, sextant and octant characters. |
| [`scrollbar`](#scrollbar) | mod |  |
| [`shade`](#shade) | mod |  |
| [`Marker`](#marker) | enum |  |
| [`DOT`](#dot) | const |  |
...
- [`bar`](./symbols/bar.md)
- [`block`](./symbols/block.md)
- [`border`](./symbols/border.md)
- [`braille`](./symbols/braille.md) — Braille symbols.
- [`half_block`](./symbols/half_block.md)
- [`line`](./symbols/line.md)
- [`marker`](./symbols/marker.md)
- [`merge`](./symbols/merge.md) — This module provides strategies for merging symbols in a layout.
- [`pixel`](./symbols/pixel.md) — Pseudo-pixel symbols: quadrant, sextant and octant characters.
- [`scrollbar`](./symbols/scrollbar.md)
- [`shade`](./symbols/shade.md)
...
- `fn clone(&self) -> Marker` — [`Marker`](./symbols/marker.md#marker)
...
- `fn default() -> Marker` — [`Marker`](./symbols/marker.md#marker)
...
- `fn from_str(s: &str) -> ::core::result::Result<Marker, <Self as ::core::str::FromStr>::Err>` — [`Marker`](./symbols/marker.md#marker)
...
- `fn eq(&self, other: &Marker) -> bool` — [`Marker`](./symbols/marker.md#marker)
