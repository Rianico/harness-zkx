*[ratatui](../index.md) / [widgets](index.md)*
...
- **`ratatui-core`**: Contains the core widget traits ([`Widget`](../prelude/index.md), [`StatefulWidget`](../prelude/index.md)) and
...
- [`calendar::Monthly`](../../ratatui_widgets/calendar/index.md): displays a single month.
...
Additionally, primitive text types implement [`Widget`](../prelude/index.md):
...
- [`Widget`](../prelude/index.md): Basic trait for stateless widgets that are consumed when rendered
- [`StatefulWidget`](../prelude/index.md): Trait for widgets that maintain state between renders
...
The [`Widget`](../prelude/index.md) trait is the most basic trait for widgets in Ratatui. It provides the basic
...
The [`StatefulWidget`](../prelude/index.md) trait is similar to the [`Widget`](../prelude/index.md) trait, but also includes state that
...
approaches. The [`StatefulWidget`](../prelude/index.md) trait represents the established pattern - it separates the
...
state. If no (like a list selection that should persist), use [`StatefulWidget`](../prelude/index.md) with external
...
For new widgets, implement [`Widget`](../prelude/index.md) or [`StatefulWidget`](../prelude/index.md) on references to your widget types
...
The recommended pattern for most new widgets implements [`Widget`](../prelude/index.md) on a shared reference,
...
For widgets that need to modify their internal state during rendering, implement [`Widget`](../prelude/index.md) on a
...
widget and should persist between widget instances - implement [`StatefulWidget`](../prelude/index.md). This is the
...
Like [`Widget`](../prelude/index.md), you can implement [`StatefulWidget`](../prelude/index.md) on references to allow reuse, though it's
...
traits for any type that implements [`Widget`](../prelude/index.md) or [`StatefulWidget`](../prelude/index.md) on a reference. This means
...
the reference-based [`Widget`](../prelude/index.md) implementation provides. In most cases, the automatic
...
than the reference-based [`Widget`](../prelude/index.md) implementation:
...
- `fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::result::Result<(), ::core::fmt::Error>` — [`Bar`](#bar), [`Widget`](../prelude/index.md#widget), [`Scrollbar`](#scrollbar)
...
- `fn from_str(s: &str) -> ::core::result::Result<ClearType, <Self as ::core::str::FromStr>::Err>` — [`Widget`](../prelude/index.md#widget), [`canvas`](#canvas), [`ScrollbarState`](#scrollbarstate)
...
- `fn to_line(&self) -> Line<'_>` — [`FromCrossterm`](../backend/index.md#fromcrossterm)
...
```
 ...
 documentation for [`StatefulWidget`](../prelude/index.md) for more information on stateful widgets.
