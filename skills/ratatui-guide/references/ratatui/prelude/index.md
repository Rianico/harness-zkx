*[ratatui](../index.md) / [prelude](index.md)*
...
- `fn styled<T, S>(content: T, style: S) -> Self`
  ...
  your own type that implements [`Into<Style>`](../backend/index.md)).
...
- `fn styled_graphemes<S: Into<Style>>(self: &'a Self, base_style: S) -> impl Iterator<Item = StyledGrapheme<'a>>` — [`dimmed`](../widgets/index.md#dimmed)

  Returns an iterator over the graphemes held by this span.

  

  `base_style` is the [`Style`](../../ratatui_core/style/index.md) that will be patched with the `Span`'s `style` to get the

  resulting [`Style`](../../ratatui_core/style/index.md).

  

  `base_style` accepts any type that is convertible to [`Style`](../../ratatui_core/style/index.md) (e.g. [`Style`](../../ratatui_core/style/index.md), [`Color`](../../ratatui_core/index.md),

  or your own type that implements [`Into<Style>`](../backend/index.md)).
...
- `fn into_left_aligned_line(self) -> Line<'a>` — [`FromCrossterm`](../backend/index.md#fromcrossterm)
...
- `fn to_left_aligned_line(self) -> Line<'a>` — [`FromCrossterm`](../backend/index.md#fromcrossterm)

- `fn into_centered_line(self) -> Line<'a>` — [`FromCrossterm`](../backend/index.md#fromcrossterm)
...
- `fn to_centered_line(self) -> Line<'a>` — [`FromCrossterm`](../backend/index.md#fromcrossterm)

- `fn into_right_aligned_line(self) -> Line<'a>` — [`FromCrossterm`](../backend/index.md#fromcrossterm)
...
- `fn to_right_aligned_line(self) -> Line<'a>` — [`FromCrossterm`](../backend/index.md#fromcrossterm)
...
- `fn render(self, area: Rect, buf: &mut Buffer)` — [`run`](../index.md#run), [`IntoCrossterm`](../backend/index.md#intocrossterm)
...
The text's [`Style`](../../ratatui_core/style/index.md) is used by the rendering widget to determine how to style the text. Each
[`Line`](../../ratatui_crossterm/index.md) in the text will be styled with the [`Style`](../../ratatui_core/style/index.md) of the text, and then with its own
[`Style`](../../ratatui_core/style/index.md). `Text` also implements [`Styled`](#styled) which means you can use the methods of the
...
- `fn iter(&self) -> core::slice::Iter<'_, Line<'a>>` — [`FromCrossterm`](../backend/index.md#fromcrossterm)

  Returns an iterator over the lines of the text.

- `fn iter_mut(&mut self) -> core::slice::IterMut<'_, Line<'a>>` — [`FromCrossterm`](../backend/index.md#fromcrossterm)
...
- `fn add(self, line: Line<'a>) -> <Self as >::Output` — [`FromCrossterm`](../backend/index.md#fromcrossterm)
...
- `fn add_assign(&mut self, line: Line<'a>)` — [`FromCrossterm`](../backend/index.md#fromcrossterm)
...
- `fn into_iter(self) -> <Self as >::IntoIter` — [`CrosstermBackend`](../backend/index.md#crosstermbackend)
...
See [`constraint!`](../../ratatui_crossterm/index.md)  or [`constraints!`](../backend/index.md) for more information.
