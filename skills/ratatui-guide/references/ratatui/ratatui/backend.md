...
- `const fn cursor_position(&self) -> Position` — [`backend`](./prelude.md#backend)
...
- `const fn scrollback(&self) -> &Buffer` — [`IntoCrossterm`](#intocrossterm)
  ...
  using [`Backend::append_lines`](./prelude.md).

  

  The scrollback buffer has a maximum height of [`u16::MAX`](../ratatui_core/backend.md). If lines are appended to the
...
- `fn draw<'a, I>(&mut self, content: I) -> core::result::Result<(), core::convert::Infallible>` — [`Widget`](./prelude.md#widget), [`Terminal`](./prelude.md#terminal)

- `fn hide_cursor(&mut self) -> core::result::Result<(), core::convert::Infallible>` — [`Widget`](./prelude.md#widget), [`Terminal`](./prelude.md#terminal)

- `fn show_cursor(&mut self) -> core::result::Result<(), core::convert::Infallible>` — [`Widget`](./prelude.md#widget), [`Terminal`](./prelude.md#terminal)

- `fn get_cursor_position(&mut self) -> core::result::Result<Position, core::convert::Infallible>` — [`Widget`](./prelude.md#widget), [`backend`](./prelude.md#backend), [`Terminal`](./prelude.md#terminal)

- `fn set_cursor_position<P: Into<Position>>(&mut self, position: P) -> core::result::Result<(), core::convert::Infallible>` — [`Widget`](./prelude.md#widget), [`Terminal`](./prelude.md#terminal)

- `fn clear(&mut self) -> core::result::Result<(), core::convert::Infallible>` — [`Widget`](./prelude.md#widget), [`Terminal`](./prelude.md#terminal)

- `fn clear_region(&mut self, clear_type: ClearType) -> core::result::Result<(), core::convert::Infallible>` — [`canvas`](./widgets.md#canvas), [`Widget`](./prelude.md#widget), [`Terminal`](./prelude.md#terminal)

- `fn append_lines(&mut self, line_count: u16) -> core::result::Result<(), core::convert::Infallible>` — [`Widget`](./prelude.md#widget), [`Terminal`](./prelude.md#terminal)
...
- `fn size(&self) -> core::result::Result<Size, core::convert::Infallible>` — [`Widget`](./prelude.md#widget), [`Chart`](./widgets.md#chart), [`Terminal`](./prelude.md#terminal)

- `fn window_size(&mut self) -> core::result::Result<WindowSize, core::convert::Infallible>` — [`Widget`](./prelude.md#widget), [`Dataset`](./widgets.md#dataset), [`Terminal`](./prelude.md#terminal)

- `fn flush(&mut self) -> core::result::Result<(), core::convert::Infallible>` — [`Widget`](./prelude.md#widget), [`Terminal`](./prelude.md#terminal)
