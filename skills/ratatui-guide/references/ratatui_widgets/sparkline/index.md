*[ratatui_widgets](../index.md) / [sparkline](index.md)*
...
The bars are rendered using a set of symbols. The default set is [`symbols::bar::NINE_LEVELS`](../../ratatui_core/symbols/block/index.md).
...
- `Sparkline::block` wraps the sparkline in a [`Block`](../block/index.md)
...
- `fn absent_value_symbol(self, symbol: impl Into<String>) -> Self`
  ...
  The default is [`symbols::shade::EMPTY`](../../ratatui_core/symbols/shade/index.md).
...
- `const fn bar_set(self, bar_set: symbols::bar::Set<'a>) -> Self`
  ...
  Can be [`symbols::bar::THREE_LEVELS`](../../ratatui_core/symbols/bar/index.md), [`symbols::bar::NINE_LEVELS`](../../ratatui_core/symbols/block/index.md) (default) or a custom
