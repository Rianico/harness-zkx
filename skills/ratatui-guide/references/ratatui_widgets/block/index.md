*[ratatui_widgets](../index.md) / [block](index.md)*
...
A [`Shadow`](../index.md) is rendered in an offset area relative to the block. Its [`Style`](../../ratatui_core/style/index.md) is applied
...
- `Block::border_set` - Sets custom border symbols as a [`border::Set`](../../ratatui_core/symbols/block/index.md)
...
Most widgets in Ratatui accept a block parameter. For example, [`Paragraph`](../paragraph/index.md), [`List`](../list/index.md),
[`Table`](../table/index.md), and other widgets can be wrapped with a block:
...
- [`MergeStrategy`](../../ratatui_core/symbols/merge/index.md) - Controls how borders merge with adjacent elements

#### Implementations

- `const fn new() -> Self`

  Creates a new block with no [`Borders`](../borders/index.md) or [`Padding`](../index.md).
...
- `fn title_style<S: Into<Style>>(self, style: S) -> Self`
  ...
  See [`Style`](../../ratatui_core/style/index.md) for more information on how merging styles works.
...
- `fn style<S: Into<Style>>(self, style: S) -> Self`
  ...
  This is the most generic [`Style`](../../ratatui_core/style/index.md) a block can receive, it will be merged with any other
  ...
  a container for another widget (e.g. a [`Paragraph`](../paragraph/index.md)), then the style of the widget is
...
- `const fn borders(self, flag: Borders) -> Self` — [`Borders`](../borders/index.md#borders)

  Defines which borders to display.

  

  [`Borders`](../borders/index.md) can also be styled with `Block::border_style` and `Block::border_type`.
...
- `const fn border_type(self, border_type: BorderType) -> Self` — [`BorderType`](../borders/index.md#bordertype)
  ...
  See [`BorderType`](../borders/index.md) for the full list of available symbols.
...
- `const fn border_set(self, border_set: border::Set<'a>) -> Self`
  ...
  Sets the symbols used to display the border as a [`ratatui_core::symbols::border::Set`](../../ratatui_core/symbols/block/index.md).
...
- `const fn merge_borders(self, strategy: MergeStrategy) -> Self`
  ...
  Sets the block's [`MergeStrategy`](../../ratatui_core/symbols/merge/index.md) for overlapping characters, defaulting to `Replace`.
  ...
  For more information and examples, see the [collapse borders recipe] and [`MergeStrategy`](../../ratatui_core/symbols/merge/index.md)
