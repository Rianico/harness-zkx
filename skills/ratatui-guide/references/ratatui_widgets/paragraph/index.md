*[ratatui_widgets](../index.md) / [paragraph](index.md)*
...
The text can be surrounded by a [`Block`](../block/index.md) with a title and borders. The block can be configured
with the [`block`](../block/index.md) method.
...
- `fn block(self, block: Block<'a>) -> Self` — [`Block`](../block/index.md#block)
  ...
  Surrounds the [`Paragraph`](#paragraph) widget with a [`Block`](../block/index.md).
...
- `fn line_count(&self, width: u16) -> usize`
   ...
   This method will also account for the [`Block`](../block/index.md) if one is set through `Self::block`.
...
- `fn line_width(&self) -> usize`
   ...
   Accounts for the [`Block`](../block/index.md) if a block is set through `Self::block`.
