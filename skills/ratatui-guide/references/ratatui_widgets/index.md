...
- [`BarChart`](barchart/index.md): displays multiple datasets as bars with optional grouping.
- [`Block`](block/index.md): a basic widget that draws a block with optional borders, titles, and styles.
- `calendar::Monthly`: displays a single month.
- [`Canvas`](canvas/index.md): draws arbitrary shapes using drawing characters.
- [`Chart`](chart/index.md): displays multiple datasets as lines or scatter graphs.
- [`Clear`](clear/index.md): clears the area it occupies. Useful to render over previously drawn widgets.
- [`Fill`](fill/index.md): paints every cell in its area with a single repeated symbol and style.
- [`Gauge`](gauge/index.md): displays progress percentage using block characters.
- [`LineGauge`](gauge/index.md): displays progress as a line.
- [`List`](list/index.md): displays a list of items and allows selection.
- [`RatatuiLogo`](logo/index.md): displays the Ratatui logo.
- [`RatatuiMascot`](mascot/index.md): displays the Ratatui mascot.
- [`Paragraph`](paragraph/index.md): displays a paragraph of optionally styled and wrapped text.
- [`Scrollbar`](scrollbar/index.md): displays a scrollbar.
- [`Sparkline`](sparkline/index.md): displays a single dataset as a sparkline.
- [`Table`](table/index.md): displays multiple rows and columns in a grid and allows selection.
- [`Tabs`](tabs/index.md): displays a tab bar and allows selection.
...
- [`barchart`](barchart/index.md) — The [`BarChart`] widget and its related types (e.g. [`Bar`], [`BarGroup`]).
- [`block`](block/index.md) — Elements related to the `Block` base widget.
- [`borders`](borders/index.md) — Border related types ([`Borders`], [`BorderType`]) and a macro to create borders ([`border`]).
- [`canvas`](canvas/index.md) — A [`Canvas`] and a collection of [`Shape`]s.
- [`chart`](chart/index.md) — The [`Chart`] widget is used to plot one or more [`Dataset`] in a cartesian coordinate system.
- [`clear`](clear/index.md) — The [`Clear`] widget allows you to clear a certain area to allow overdrawing (e.g. for popups).
- [`fill`](fill/index.md) — The [`Fill`] widget paints every cell in its area with a single symbol and style.
- [`gauge`](gauge/index.md) — The [`Gauge`] widget is used to display a horizontal progress bar.
- [`list`](list/index.md) — The [`List`] widget is used to display a list of items and allows selecting one or multiple
- [`logo`](logo/index.md) — The [`RatatuiLogo`] widget renders the Ratatui logo.
- [`mascot`](mascot/index.md) — A Ratatui mascot widget
- [`paragraph`](paragraph/index.md) — The [`Paragraph`] widget and related types allows displaying a block of text with optional
- [`scrollbar`](scrollbar/index.md) — The [`Scrollbar`] widget is used to display a scrollbar alongside other widgets.
- [`sparkline`](sparkline/index.md) — The [`Sparkline`] widget is used to display a sparkline over one or more lines.
- [`table`](table/index.md) — The [`Table`] widget is used to display multiple rows and columns in a grid and allows selecting
- [`tabs`](tabs/index.md) — The [`Tabs`] widget displays a horizontal set of tabs with a single tab selected.
- [`calendar`](calendar/index.md) — A simple calendar widget. `(feature: widget-calendar)`

## Macros

### `border!`

Macro that constructs and returns a combination of the [`Borders`](borders/index.md) object from TOP, BOTTOM, LEFT
and RIGHT.
