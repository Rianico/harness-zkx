*[ratatui_widgets](../index.md) / [scrollbar](index.md)*
...
- `const fn orientation(self, orientation: ScrollbarOrientation) -> Self` — [`ScrollbarOrientation`](#scrollbarorientation)
  ...
  Resets the symbols to [`DOUBLE_VERTICAL`](../../ratatui_core/symbols/scrollbar/index.md) or [`DOUBLE_HORIZONTAL`](../../ratatui_core/symbols/scrollbar/index.md) based on orientation.
...
- `const fn orientation_and_symbol(self, orientation: ScrollbarOrientation, symbols: Set<'a>) -> Self` — [`ScrollbarOrientation`](#scrollbarorientation)
  ...
  Sets the orientation and symbols for the scrollbar from a [`Set`](../../ratatui_core/symbols/block/index.md).
...
- `const fn symbols(self, symbols: Set<'a>) -> Self`
  ...
  Sets the symbols used for the various parts of the scrollbar from a [`Set`](../../ratatui_core/symbols/block/index.md).
...
- `fn style<S: Into<Style>>(self, style: S) -> Self`
  ...
  Sets the style used for the various parts of the scrollbar from a [`Style`](../../ratatui_core/style/index.md).
