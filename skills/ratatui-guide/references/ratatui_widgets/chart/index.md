*[ratatui_widgets](../index.md) / [chart](index.md)*
...
- `const fn marker(self, marker: symbols::Marker) -> Self`
  ...
  [`Marker::Custom`](symbols::Marker::Custom). See [`symbols::Marker`](../../ratatui_core/symbols/marker/index.md) for more details.
...
- `fn block(self, block: Block<'a>) -> Self` — [`Block`](../block/index.md#block)
  ...
  Wraps the chart with the given [`Block`](../block/index.md)
