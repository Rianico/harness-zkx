*[ratatui_widgets](./index.md) / [borders](#)*

---

# Module `borders`

Border related types ([`Borders`](#borders), [`BorderType`](#bordertype)) and a macro to create borders ([`border`](../ratatui_core/symbols/border.md)).
