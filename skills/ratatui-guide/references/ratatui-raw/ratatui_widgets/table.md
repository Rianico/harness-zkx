*[ratatui_widgets](./index.md) / [table](#)*
...
You can apply a [`Style`](../ratatui_core/style.md) to the [`Cell`](./index.md) using `Cell::style`. This will set the style for the
entire area of the cell. Any [`Style`](../ratatui_core/style.md) set on the [`Text`](../ratatui_core/index.md) content will be combined with the
[`Style`](../ratatui_core/style.md) of the [`Cell`](./index.md) by adding the [`Style`](../ratatui_core/style.md) of the [`Text`](../ratatui_core/index.md) content to the [`Style`](../ratatui_core/style.md) of
...
You can set the style of the entire row using `Row::style`. This [`Style`](../ratatui_core/style.md) will be combined
with the [`Style`](../ratatui_core/style.md) of each individual [`Cell`](./index.md) by adding the [`Style`](../ratatui_core/style.md) of the [`Cell`](./index.md) to the
[`Style`](../ratatui_core/style.md) of the [`Row`](./index.md).
...
- `fn style<S: Into<Style>>(self, style: S) -> Self`
  ...
  Set the [`Style`](../ratatui_core/style.md) of the entire row
  ...
  This [`Style`](../ratatui_core/style.md) can be overridden by the [`Style`](../ratatui_core/style.md) of a any individual [`Cell`](./index.md) or by their
...
- `Table::block` wraps the table in a [`Block`](./block.md) widget.
...
- `fn block(self, block: Block<'a>) -> Self` — [`Block`](./block.md#block)
  ...
  Wraps the table with a custom [`Block`](./block.md) widget.

  

  The `block` parameter is of type [`Block`](./block.md). This holds the specified block to be
