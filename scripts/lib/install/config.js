...
const DEFAULT_INSTALL_CONFIG = 'lsz-install.json';
const CONFIG_SCHEMA_PATH = path.join(__dirname, '..', '..', '..', 'schemas', 'lsz-install-config.schema.json');
...
function getValidator() {
  ...
  const schema = readJson(CONFIG_SCHEMA_PATH, 'lsz-install-config.schema.json');
