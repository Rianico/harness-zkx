...
# Install LSZ git safety hooks globally via core.hooksPath.
# Usage:
...
DEST_DIR="${LSZ_GLOBAL_HOOKS_DIR:-$HOME/.codex/git-hooks}"
...
log "Installed LSZ global git hooks."
log "Disable per repo by creating .lsz-hooks-disable in project root."
log "Temporary bypass: LSZ_SKIP_PRECOMMIT=1 or LSZ_SKIP_PREPUSH=1"
