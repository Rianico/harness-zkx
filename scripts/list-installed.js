...
Inspect LSZ install-state files for the current home/project context.
`);
...
function printHuman(records) {
  if (records.length === 0) {
    console.log('No LSZ install-state files found for the current home/project context.');
    return;
  }

  console.log('Installed LSZ targets:\n');
