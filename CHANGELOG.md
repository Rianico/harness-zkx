...
* **herdr:** verify delivery revision increment and fail on stale prompt ([#148](https://github.com/Rianico/harness-zkx/issues/148)) (#151)
...
* **scaffold:** ship the current stable toolchain in every flavor
* **scaffold:** canonicalize generated bytes and ship the targets gates need
...
* **herdr:** document hierarchical lane coordination and TM contracts
...
* **protocol:** extract subagent response format to common rule and ai-engineering spine
